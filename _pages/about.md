...
- I have **published** in multiple A* conferences and workshops, including ICLR, CVPR, Interspeech, NeuRIPS, EMNLP, and ACL. A full list of my publications can be found [here](/publications). 
...
```
"I, for one, welcome our interpretable and computationally modest overlords." - me
```
